...
const Wishlist = ({wishlist, handleRemove, handleAddToCard}) => {
    ...
    return (
        <div id="wishlist" className="flex flex-col sm:flex-row justify-between p-3 sm:p-4 md:p-5 rounded-xl bg-white items-center mb-4 sm:mb-5 md:mb-6 gap-3 sm:gap-0">
  ...
  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-5 items-center w-full sm:w-auto">
    ...
    <div className="flex flex-col gap-y-2 sm:gap-y-3 text-center sm:text-left items-center sm:items-start">
      ...
      <button
        ...
        className="btn w-36 sm:w-38 md:w-40 rounded-2xl bg-[rgba(149,56,226,1)] text-white font-medium text-sm sm:text-base"
      >
        Add to Card
      </button>
    </div>
